...
import (
	...
	pb "hyperledger.abchain.org/adapter/yafabric/client/protos"
...
//RPCManager is for control the running of rpc
type RPCManager struct {
	ctx    context.Context
	cancel context.CancelFunc
}

//Rpc has been depecrated
type Rpc struct {
}

//NewManager@Rpc just for compatible reason
func (*Rpc) NewManager() *RPCManager {

	return NewRpcManager()
}

//NewRpcManager create a new RPCManager
...
//Context expose the underlying context
func (m *RPCManager) Context() context.Context {

	return m.ctx
}

//Cancel stop the running
func (m *RPCManager) Cancel() {

	m.cancel()
}

//RpcBuilder is a builder for rpc call
...
//SecurityPolicy specify the possible sec policy
